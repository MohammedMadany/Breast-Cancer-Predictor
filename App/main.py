...
def get_scaled_values(input_dictionary):
    data = get_clean_data()
...
def main():
    ...
    with open("Holdings/style.css") as f:
    ...
    with st.container():
        ...
        st.write("Discover a breakthrough in breast cancer diagnosis with our user-friendly app that seamlessly connects to our cytology lab. Using the latest in machine learning technology, our app predicts the nature of breast masses – whether they are benign or malignant – based on precise measurements from our cutting-edge lab. You can also take control and update the measurements manually through easy-to-use sliders in the sidebar. Experience a simplified and efficient diagnostic process, where technology meets healthcare in the palm of your hand. Welcome to a smarter, more accessible approach to breast cancer detection. ")
